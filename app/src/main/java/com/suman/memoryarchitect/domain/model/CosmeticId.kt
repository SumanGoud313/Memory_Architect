...
enum class CosmeticId {
    ...
    ROOM_FOUNDER_HERITAGE,
    MATERIAL_FOUNDER_BRASS,
    ...
    BADGE_CYBER_CHIP,
    ROOM_CYBER_GRIDWORKS,
    MATERIAL_CYBER_CHROME_CIRCUIT,
    ...
    BADGE_SPACE_COMET,
    ROOM_SPACE_NEBULA_DOCK,
    MATERIAL_SPACE_GUNMETAL,
