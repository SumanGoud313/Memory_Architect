...
/** The full achievement catalog (locked + unlocked) - reached via Profile's "Achievements" button.
 * Pulled out of the Profile scroll itself so Profile stays a short overview and this becomes its
 * own dedicated destination, same relationship [com.suman.memoryarchitect.ui.screens.statistics.StatisticsScreen]
 * already has to Profile. */
@Composable
